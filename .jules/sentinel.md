...
## 2026-07-30 - Reusable CI/CD Workflow Hardening Pattern
...
**Learning:** Hardening GitHub Actions is a form of defense in depth. Explicitly declaring `permissions: read-all` at the global level mitigates risks of compromised tokens, and pinning all external actions to immutable 40-character SHA-1 commit hashes guarantees that only reviewed and verified action code is executed.
