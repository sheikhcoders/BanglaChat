...
// Performance Optimization (Bolt): Module-level array hoisting for simulated bot replies.
// Hoisting BOT_REPLIES array prevents allocating a new array and multiple string references on the heap
// on every simulated bot reply submission timeout, reducing garbage collection pressure and main thread overhead.
const BOT_REPLIES = [
...
frm.addEventListener("submit", (e) => {
  ...
  setTimeout(() => {
    ...
    // Performance Optimization (Bolt): Pick from hoisted module-level array to eliminate heap allocations.
